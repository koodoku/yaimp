 ...
 */
final class Version20241116061408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE depositary (id INT AUTO_INCREMENT NOT NULL, stock_id INT NOT NULL, portfolio_id INT NOT NULL, count INT NOT NULL, INDEX IDX_7CD08B68DCD6110 (stock_id), INDEX IDX_7CD08B68B96B5643 (portfolio_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
