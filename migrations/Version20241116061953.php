 ...
 */
final class Version20241116061953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE depositary (id INT AUTO_INCREMENT NOT NULL, stock_id INT NOT NULL, INDEX IDX_7CD08B68DCD6110 (stock_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
